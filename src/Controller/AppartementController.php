...
class AppartementController extends AbstractController
{
    ...
    public function index(AppartementRepository $appartementRepository, UserRepository $userRepository): Response
    {
    ...
    public function new(Request $request, AppartementRepository $appartementRepository): Response
    {
        ...
        $form = $this->createForm(Appartement2Type::class, $appartement);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            // $appMailer->sendNewAppartementNotification($appartement, $users);
